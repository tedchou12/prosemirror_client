...
function isEnum(items) {
    return object => (items).includes(object)
}
...
function isArrayOfStrings(object) {
    return Array.isArray(object)
        && object.every(item => isString(item))
}

function getDefaultFlowArgs() {
    return process.stdout.isTTY
        ? ['--color=always']
        : []
}

function applyOptionsDefaults(optionalOptions) {
